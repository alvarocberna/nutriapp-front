    ...
    <div className="w-full h-full flex items-center justify-center p-10">
      <div className="flex flex-col items-center">
        ...
        <div className="relative" style={{zIndex: 2}}>
          <div className="w-30 h-30 bg-blue-200 flex items-center justify-center relative shadow-md"
          style={{borderRadius: '60px 60px 60px 55px'}}>

            {/* OJOS */}
            <div className="absolute top-16 left-6 flex gap-8">
              <div className={`w-4 ${blink ? "h-1" : "h-4"} bg-black rounded-full transition-all`}></div>
              <div className={`w-4 ${blink ? "h-1" : "h-4"} bg-black rounded-full transition-all`}></div>
            </div>

            {/* CEJAS */}
            <div className="absolute top-12 left-4 flex gap-8">
              <div className={`w-6 h-1 bg-black rounded-full transition-transform ${eyebrowLift ? "-translate-y-1" : ""}`}></div>
              <div className={`w-6 h-1 bg-black rounded-full transition-transform ${eyebrowLift ? "-translate-y-1" : ""}`}></div>
            </div>
          </div>
        </div>
        ...
        <div className="mt-[-25px] relative" style={{zIndex: '1'}}>
          {/* TORSO */}
          <div className="bg-blue-300 w-35 h-25 shadow-md flex justify-center pt-10" style={{borderRadius: '80px 80px 0 0'}}>

            {/* BRAZOS */}
            <div className="flex gap-16 absolute top-16">
        ...
        {/* COMPUTADOR */}
        <div className="relative mr-[80] h-[100px] w-[250px]">
          {/* Pantalla */}
          ...
          {/* Base */}
          <Image  src="/images/teclado.png" width={250} height={100} alt="Teclado de computador" 
            className=""/>
          <Image  src="/images/pantalla.png" width={250} height={100} alt="Teclado de computador" 
            className="absolute bottom-15 right-20" style={{zIndex: 3}}/>
